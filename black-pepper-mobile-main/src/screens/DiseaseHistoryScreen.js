...
export default function DiseaseHistoryScreen({ navigation }) {
  ...
  const clearHistory = async () => {
    Alert.alert('Clear History', 'Are you sure you want to delete all saved results?', [
                  ...
                  >
                    ...
                    <View style={styles.cardContent}>
                      <View style={styles.cardTopRow}>
                        <Text style={styles.disease}>{item.disease || 'Unknown disease'}</Text>
                      ...
                      <Text style={styles.metaText}>Confidence: {item.confidence || 'N/A'}</Text>
                      <Text style={styles.metaText}>Saved: {item.savedAt || 'Unknown date'}</Text>

                      <Text style={styles.shortDesc}>{getShortDescription(item.description)}</Text>
                    ...
                    <View style={styles.tooltip}>
                      ...
                      {item.lowConfidence && (
                        <Text style={styles.tooltipWarning}>
                          ⚠ This was saved as a low-confidence or possible early infection result.
                        </Text>
                      )}
                    </View>
                  )}
