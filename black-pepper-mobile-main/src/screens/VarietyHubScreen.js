...
const VARIETIES = [
  { name:'Butawerala',     emoji:'🫑', color:'#2E7D32', traits:['High yield','Disease resistant','Bold berries'],    desc:'The most widely cultivated variety in Sri Lanka. Known for bold berries and strong disease resistance.' },
  { name:'Dingirala',      emoji:'🌿', color:C.blue,    traits:['Aromatic','Medium yield','Early bearing'],           desc:'Prized for its strong aroma and pungency. Reaches bearing stage earlier than other varieties.' },
  { name:'Kohukuburerala', emoji:'🍃', color:C.purple,  traits:['Long spikes','High pungency','Heavy fruiting'],      desc:'Distinguished by long spikes and high piperine content. Preferred for export quality.' },
];
        ...
        <LinearGradient colors={[C.teal, '#00ACC1', '#26C6DA']} style={s.hero}>
          <Animated.View style={{ opacity:fade, transform:[{translateY:slide}] }}>
            ...
            <Text style={s.heroSub}>
              AI identifies Butawerala, Dingirala & Kohukuburerala from leaf images with high accuracy
            </Text>
          </Animated.View>
        </LinearGradient>
        ...
        <Animated.View style={{ opacity:fade, transform:[{translateY:slide}] }}>
          ...
          <View style={s.section}>
            ...
            <View style={s.actionRow}>
              <TouchableOpacity style={[s.actionCard, { borderColor:C.teal+'44', backgroundColor:'#E0F7FA' }]}
                onPress={() => navigation.navigate('VarietyIdentify')} activeOpacity={0.82}
                accessibilityRole="button" accessibilityLabel="Identify variety">
              ...
              <TouchableOpacity style={[s.actionCard, { backgroundColor:C.white, borderColor:C.border }]}
                onPress={() => navigation.navigate('VarietyHistory')} activeOpacity={0.82}
                accessibilityRole="button" accessibilityLabel="View scan history">
                ...
                <View style={[s.actionBtn, { backgroundColor:C.white, borderWidth:1.5, borderColor:C.primary }]}>
          ...
          <View style={s.section}>
            ...
            {VARIETIES.map(v => (
              <TouchableOpacity key={v.name} style={s.varietyCard}
                ...
                <View style={{ flex:1 }}>
                  ...
                  <View style={s.traitRow}>
                    {v.traits.map(t => (
                      <View key={t} style={[s.trait, { backgroundColor:v.color+'15', borderColor:v.color+'33' }]}>
          ...
          <View style={s.infoCard}>
            ...
            {[
              { icon:'shield-checkmark-outline', txt:'Stage A: Verifies the image is a black pepper leaf (filters non-leaf images)' },
              { icon:'scan-outline',             txt:'Stage B: EfficientNet classifies among 3 Sri Lankan varieties' },
...
const s = StyleSheet.create({
  ...
  sectionCap:   { fontSize:10, fontWeight:'800', color:C.text3, letterSpacing:2, marginBottom:8 },
  ...
  actionBtn:    { borderRadius:12, paddingVertical:10, paddingHorizontal:16, alignSelf:'flex-start' },
  actionBtnTxt: { color:C.white, fontSize:13, fontWeight:'700' },

  varietyCard:  { flexDirection:'row', alignItems:'center', backgroundColor:C.white, borderRadius:18, padding:14, marginBottom:10, borderWidth:1, borderColor:C.border, ...SHADOW.xs },
  varietyIcon:  { width:52, height:52, borderRadius:16, justifyContent:'center', alignItems:'center', marginRight:12 },
  ...
  infoCard:  { backgroundColor:C.xlight, marginHorizontal:16, borderRadius:18, padding:16, borderWidth:1, borderColor:C.light, marginTop:6 },
