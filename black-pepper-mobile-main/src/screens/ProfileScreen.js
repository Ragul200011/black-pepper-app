...
export default function ProfileScreen({ navigation }) {
  ...
  const statCards = [
    { icon: 'bug-outline',       color: '#C62828', bg: '#FFEBEE', label: 'Disease Scans',  val: stats.disease  },
    { icon: 'leaf-outline',      color: '#2E7D32', bg: '#E8F5E9', label: 'Variety Scans',  val: stats.variety  },
    { icon: 'home-outline',      color: '#1565C0', bg: '#E3F2FD', label: 'Registered Farms', val: FARMS_COUNT  },
    { icon: 'analytics-outline', color: '#6A1B9A', bg: '#F3E5F5', label: 'Total Analyses', val: stats.disease + stats.variety },
  ];
      ...
      <LinearGradient colors={['#0A1F05', '#1B5E20', '#2E7D32']} style={s.hero}>
        ...
        {editing ? (
          <View style={s.nameEditRow}>
            ...
            <TouchableOpacity style={s.nameCancelBtn} onPress={() => { setEditing(false); setNameInput(user?.name ?? ''); }}>
        ...
        <View style={s.roleTag}>
          <Ionicons name="shield-checkmark-outline" size={11} color="#A5D6A7" style={{ marginRight: 4 }} />
...
const s = StyleSheet.create({
  ...
  hero:        { paddingTop: Platform.OS === 'ios' ? 60 : 44, paddingBottom: 32, alignItems: 'center', paddingHorizontal: 20 },
  avatarWrap:  { position: 'relative', marginBottom: 14 },
  avatar:      { width: 88, height: 88, borderRadius: 44, backgroundColor: 'rgba(255,255,255,0.2)', justifyContent: 'center', alignItems: 'center', borderWidth: 3, borderColor: 'rgba(255,255,255,0.4)' },
  avatarTxt:   { fontSize: 30, fontWeight: '900', color: '#fff' },
  editAvatarBtn:{ position: 'absolute', bottom: 0, right: 0, width: 28, height: 28, borderRadius: 14, backgroundColor: C.primary, justifyContent: 'center', alignItems: 'center', borderWidth: 2, borderColor: '#fff' },

  nameEditRow: { flexDirection: 'row', alignItems: 'center', gap: 8, marginBottom: 8 },
  nameInput:   { flex: 1, backgroundColor: 'rgba(255,255,255,0.15)', borderRadius: 12, paddingHorizontal: 14, paddingVertical: 8, fontSize: 18, fontWeight: '700', color: '#fff', borderWidth: 1, borderColor: 'rgba(255,255,255,0.3)', textAlign: 'center' },
  nameSaveBtn: { width: 36, height: 36, borderRadius: 10, backgroundColor: 'rgba(255,255,255,0.2)', justifyContent: 'center', alignItems: 'center' },
  nameCancelBtn:{ width: 36, height: 36, borderRadius: 10, justifyContent: 'center', alignItems: 'center' },

  heroName:  { fontSize: 24, fontWeight: '900', color: '#fff', marginBottom: 4, textAlign: 'center' },
  heroEmail: { fontSize: 13, color: 'rgba(255,255,255,0.75)', marginBottom: 10 },
  roleTag:   { flexDirection: 'row', alignItems: 'center', backgroundColor: 'rgba(255,255,255,0.12)', borderRadius: 20, paddingHorizontal: 12, paddingVertical: 5 },
  roleTagTxt:{ fontSize: 11, color: '#A5D6A7', fontWeight: '600' },

  statsGrid: { flexDirection: 'row', flexWrap: 'wrap', padding: 12, gap: 10 },
  statCard:  { flex: 1, minWidth: '44%', backgroundColor: C.surface, borderRadius: 18, padding: 16, alignItems: 'center', ...SHADOW.sm, borderWidth: 1, borderColor: C.border },
  statIcon:  { width: 44, height: 44, borderRadius: 13, justifyContent: 'center', alignItems: 'center', marginBottom: 10 },
  ...
  sectionTitle: { fontSize: 13, fontWeight: '800', color: C.text3, letterSpacing: 0.8, marginBottom: 10, textTransform: 'uppercase' },

  menuCard:      { backgroundColor: C.surface, borderRadius: 18, overflow: 'hidden', ...SHADOW.sm, borderWidth: 1, borderColor: C.border },
  ...
  menuIconBox:   { width: 36, height: 36, borderRadius: 10, backgroundColor: C.xlight, justifyContent: 'center', alignItems: 'center' },
  menuLabel:     { flex: 1, fontSize: 14, fontWeight: '600', color: C.text },

  infoCard:     { backgroundColor: C.surface, borderRadius: 18, overflow: 'hidden', ...SHADOW.sm, borderWidth: 1, borderColor: C.border },
  ...
  signOutBtn: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', backgroundColor: '#FFEBEE', borderRadius: 16, paddingVertical: 16, borderWidth: 1, borderColor: '#FFCDD2' },
