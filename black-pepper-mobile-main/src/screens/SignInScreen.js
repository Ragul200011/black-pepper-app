    ...
    <KeyboardAvoidingView style={s.root} behavior={Platform.OS === 'ios' ? 'padding' : undefined}>
      ...
      >
        <Animated.View style={{ opacity: fade, transform: [{ translateY: slide }] }}>
          ...
          <View
            style={[s.inputRow, focused === 'email' && s.focused, !!errors.email && s.errBorder]}
          >
            <Ionicons
              name="mail-outline"
              size={18}
              color={focused === 'email' ? C.lime : C.dim}
          ...
          <View
            style={[s.inputRow, focused === 'pass' && s.focused, !!errors.password && s.errBorder]}
          >
            <Ionicons
              name="lock-closed-outline"
              size={18}
              color={focused === 'pass' ? C.lime : C.dim}
              style={{ marginRight: 10 }}
            />
            <TextInput
              ref={passRef}
...
const s = StyleSheet.create({
  ...
  glow: {
    ...
    height: 260,
    borderRadius: 130,
    backgroundColor: 'rgba(42,107,43,0.10)',
    top: -100,
    right: -70,
  },
  backBtn: {
