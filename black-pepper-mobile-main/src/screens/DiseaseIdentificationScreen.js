...
const DISEASES = [
  { name:'Leaf Blight',    emoji:'🍂', color:'#C62828', desc:'Brown/black necrotic lesions on leaves. Caused by Colletotrichum gloeosporioides.' },
  { name:'Slow Wilt',      emoji:'🥀', color:'#E65100', desc:'Progressive wilting and yellowing. Caused by Phytophthora capsici in soil.' },
  { name:'Healthy Leaf',   emoji:'🌿', color:C.success,  desc:'No signs of disease. Ideal leaf condition for black pepper cultivation.' },
];
      ...
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={s.scroll}>
        ...
        <LinearGradient colors={['#B71C1C','#C62828','#D32F2F']} style={s.hero}>
          <Animated.View style={{opacity:fade, transform:[{translateY:slide}]}}>
            <View style={s.heroBadge}><View style={s.heroDot}/><Text style={s.heroBadgeTxt}>LEAF DISEASE AI</Text></View>
            <Text style={s.heroTitle}>Disease{'\n'}Detection</Text>
            <Text style={s.heroSub}>EfficientNetB0 identifies leaf blight & slow wilt from leaf photos with 95%+ accuracy</Text>
          </Animated.View>
        </LinearGradient>
        ...
        <Animated.View style={{opacity:fade, transform:[{translateY:slide}]}}>
          ...
          <View style={s.section}>
            ...
            <TouchableOpacity style={s.primaryAction} onPress={() => navigation.navigate('DiseaseUpload')} activeOpacity={0.85}>
              <LinearGradient colors={['#C62828','#D32F2F']} style={s.primaryActionGrad}>
                ...
                <View style={{flex:1}}>
                  ...
                  <Text style={s.primaryActionDesc}>Upload or capture a leaf image for AI analysis</Text>
                </View>
            ...
            <TouchableOpacity style={s.secondaryAction} onPress={() => navigation.navigate('DiseaseHistory')} activeOpacity={0.85}>
          ...
          <View style={s.infoCard}>
            ...
            {[
              ...
              {icon:'analytics-outline',      txt:'EfficientNetB0 classifies the disease with confidence %'},
              {icon:'medical-outline',        txt:'Treatment guidance provided for identified disease'},
            ].map((item, i) => (
...
const s = StyleSheet.create({
  ...
  heroTitle:    {fontSize:28, fontWeight:'900', color:C.white, lineHeight:34, marginBottom:8, letterSpacing:-0.4},
  heroSub:      {fontSize:12, color:'rgba(255,255,255,0.82)', lineHeight:18},

  section:       {paddingHorizontal:16, paddingTop:20, paddingBottom:4},
  sectionCap:    {fontSize:10, fontWeight:'800', color:C.text3, letterSpacing:2, marginBottom:12},
  ...
  primaryActionIcon: {width:56, height:56, borderRadius:18, backgroundColor:'rgba(255,255,255,0.2)', justifyContent:'center', alignItems:'center'},
  ...
  arrowCircle:       {width:36, height:36, borderRadius:18, backgroundColor:'rgba(255,255,255,0.2)', justifyContent:'center', alignItems:'center'},

  secondaryAction:     {flexDirection:'row', alignItems:'center', gap:14, backgroundColor:C.white, borderRadius:18, padding:18, borderWidth:1, borderColor:C.border, ...SHADOW.xs},
  secondaryActionIcon: {width:52, height:52, borderRadius:16, justifyContent:'center', alignItems:'center'},
  secondaryActionTitle:{fontSize:16, fontWeight:'800', color:C.text, marginBottom:3},
  secondaryActionDesc: {fontSize:12, color:C.text3},

  diseaseCard: {flexDirection:'row', alignItems:'center', gap:14, backgroundColor:C.white, borderRadius:16, padding:16, borderLeftWidth:4, borderWidth:1, borderColor:C.border, marginBottom:10, ...SHADOW.xs},
  diseaseIcon: {width:48, height:48, borderRadius:14, justifyContent:'center', alignItems:'center', flexShrink:0},
  diseaseName: {fontSize:15, fontWeight:'800', marginBottom:4},
  diseaseDesc: {fontSize:12, color:C.text3, lineHeight:17},

  infoCard:    {backgroundColor:C.white, marginHorizontal:16, borderRadius:18, padding:18, borderWidth:1, borderColor:C.border, marginTop:6, ...SHADOW.xs},
  infoHeader:  {flexDirection:'row', alignItems:'center', gap:8, marginBottom:14},
  infoTitle:   {fontSize:15, fontWeight:'800', color:C.text},
  infoIconWrap:{width:32, height:32, borderRadius:10, backgroundColor:'#FFEBEE', justifyContent:'center', alignItems:'center'},
  infoRow:     {flexDirection:'row', alignItems:'center', gap:12, marginBottom:12},
  infoTxt:     {flex:1, fontSize:13, color:C.text2, lineHeight:18},

  tipsCard:  {backgroundColor:'#E8F5E9', marginHorizontal:16, borderRadius:16, padding:16, borderWidth:1, borderColor:C.light, marginTop:14},
