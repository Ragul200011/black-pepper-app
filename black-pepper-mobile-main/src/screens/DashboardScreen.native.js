...
const MOCK_PINS = [
  ...
  {
    id: 2,
    coordinate: { latitude: 9.68, longitude: 80.04 }, // North Jaffna
  ...
  {
    id: 3,
    coordinate: { latitude: 9.645, longitude: 80.01 }, // South Jaffna
  ...
  {
    id: 4,
    coordinate: { latitude: 9.67, longitude: 79.99 }, // West Jaffna
...
export default function DashboardScreen() {
  return (
    <ScrollView style={styles.container} showsVerticalScrollIndicator={false}>
      {/* Header Section */}
      <LinearGradient colors={['#1a3409', '#2d5016', '#1a3409']} style={styles.headerSection}>
      ...
      <View style={styles.actionsSection}>
        ...
        <View style={styles.actionCard}>
          ...
          <View style={styles.actionTextContent}>
            ...
            <Text style={styles.actionDescription}>
              45% of monitored fields in South Jaffna showed severe Nitrogen depletion this week.
              Urea application recommended.
            </Text>
          </View>
        </View>
        ...
        <View style={styles.actionCard}>
          ...
          <View style={styles.actionTextContent}>
            ...
            <Text style={styles.actionDescription}>
              Slight Potassium dip detected near West Jaffna borders. Suggesting MOP (Muriate of
              Potash) preparation.
            </Text>
          </View>
        </View>
